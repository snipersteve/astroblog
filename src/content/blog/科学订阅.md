...
update 20220727 rsshub的作者似乎出国了，社区交由他人打理，可称为v2时代。v2把总router文件拆分到各路由文件夹下，好管理很多，赞。另外有个专门的docker封装了puppeteer，终于不用费劲装环境了。rsshub对于我来说最大的作用大约就是用puppeteer绕过反爬限制了，比如最近反垄断局的网站改版后原先的方法都失效了，只能再次祭出rsshub。一般的网站我更愿意用rss-proxy来搞定，基本点两下就好，十分简单。
